...
const Data := preload('room_policeman_state.gd')
@onready var mini_game: MiniGame = $MiniGame

var state: Data = load("res://game/rooms/policeman/room_policeman.tres")
...
func _on_room_transition_finished() -> void:
	await C.Policeman.say("Debes hacer click para jugar")
