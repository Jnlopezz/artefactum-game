...
const Data := preload('room_recycler_state.gd')

@onready var mini_game: MiniGame = $MiniGame

var state: Data = load("res://game/rooms/recycler/room_recycler.tres")
...
func _on_room_transition_finished() -> void:
	await C.RecyclerNpc.say("Debes hacer click para jugar")
